...
const ENTIDADE_CAMPOS_BASE: TemplateVariableField[] = [
  ...
  { campo: 'representante_1_quota', label: 'Sócio 1 - Quota (completa)', tipo: 'texto' },
  { campo: 'representante_1_quota_valor', label: 'Sócio 1 - Quota (valor bruto)', tipo: 'texto' },
  { campo: 'representante_1_quota_percentagem', label: 'Sócio 1 - Quota (%)', tipo: 'texto' },
  { campo: 'representante_1_quota_euros', label: 'Sócio 1 - Quota (€)', tipo: 'texto' },
  ...
  { campo: 'representante_2_quota', label: 'Sócio 2 - Quota (completa)', tipo: 'texto' },
  { campo: 'representante_2_quota_valor', label: 'Sócio 2 - Quota (valor bruto)', tipo: 'texto' },
  { campo: 'representante_2_quota_percentagem', label: 'Sócio 2 - Quota (%)', tipo: 'texto' },
  { campo: 'representante_2_quota_euros', label: 'Sócio 2 - Quota (€)', tipo: 'texto' },
  ...
  { campo: 'representante_3_quota', label: 'Sócio 3 - Quota (completa)', tipo: 'texto' },
  { campo: 'representante_3_quota_valor', label: 'Sócio 3 - Quota (valor bruto)', tipo: 'texto' },
  { campo: 'representante_3_quota_percentagem', label: 'Sócio 3 - Quota (%)', tipo: 'texto' },
  { campo: 'representante_3_quota_euros', label: 'Sócio 3 - Quota (€)', tipo: 'texto' },
  ...
  { campo: 'representante_4_quota', label: 'Sócio 4 - Quota (completa)', tipo: 'texto' },
  { campo: 'representante_4_quota_valor', label: 'Sócio 4 - Quota (valor bruto)', tipo: 'texto' },
  { campo: 'representante_4_quota_percentagem', label: 'Sócio 4 - Quota (%)', tipo: 'texto' },
  { campo: 'representante_4_quota_euros', label: 'Sócio 4 - Quota (€)', tipo: 'texto' },
